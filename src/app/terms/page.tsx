...
export const metadata: Metadata = {
  ...
  description:
    "Read the Terms of Service for Logo.ai, the AI-powered logo generator launching September 2026. You own what you create. Full commercial rights are included.",
};
