...
export const metadata: Metadata = {
  ...
  description:
    "Logo.ai press resources, media inquiries, and brand assets. Get the latest news about the AI logo generator launching August 2026 with 2,000,000 free logos.",
};
