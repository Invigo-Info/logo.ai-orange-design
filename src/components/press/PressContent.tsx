      ...
      >
        ...
        <ScrollReveal>
          <section className="py-14 md:py-20 border-t border-cream-05">
            ...
            <CopyBlock
              label="Short Version"
              text="Logo.ai is an AI-powered logo generator launching June 2026. Founded by serial entrepreneurs and brothers Abhinav and Ashwin Reddy, the platform creates professional logos and complete brand kits in under 60 seconds — original designs, not templates."
            />
            <CopyBlock
              label="Full Version"
              text={`Logo.ai is an AI logo generator launching June 2026. Founded by Abhinav and Ashwin Reddy — brothers and serial entrepreneurs who've spent three decades launching technology products across web, mobile, and AI, with multiple successful exits and products used by millions — the platform creates professional logos and complete brand kits in under 60 seconds. Unlike traditional logo makers that recycle templates, Logo.ai generates original designs tailored to each brand. The company is headquartered in San Francisco, with teams in Singapore, Tallinn, and Dubai. Over ${formatted} founders, creators, and brand owners are on the waitlist ahead of launch.`}
            />
          </section>
        </ScrollReveal>
